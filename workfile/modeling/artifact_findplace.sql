...
-- alter table artifact_findplace ADD column gid_0 varchar(256);
-- alter table artifact_findplace ADD column gid_1 varchar(256);
-- alter table artifact_findplace ADD column gid_2 varchar(256);
-- alter table artifact_findplace ADD column gid_3 varchar(256);
-- alter table artifact_findplace ADD column gid_4 varchar(256);
-- alter table artifact_findplace ADD column gid_5 varchar(256);