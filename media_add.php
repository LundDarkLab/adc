...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <main>
      <div class="container">
        <form name="newMediaForm" id="newMediaForm" enctype="multipart/form-data">
          <input type="hidden" id="artifact" name="artifact" data-table="files" value="<?php echo $_GET['item']; ?>">
          <input type="hidden" id="type" name="type" data-table="files" value="<?php echo $_GET['t']; ?>">
          
          <div class="row mb-3">
            <div class="col">
              <h3 class="border-bottom">Add new <span id="fileTypeText"></span> to the <span id="artifactName" class="fw-bold"></span> artifact</h3>
            </div>
          </div>
          ...
          <div class="row mb-3">
            <div class="col col-md-6" id="fileInputCol">
              <label for="path" class="form-label" id="pathLabel"><span class="visually-hidden">File input</span></label>
            ...
            <div class="col col-md-6" id="urlInputCol">
              <div class="d-flex">
                ...
                <label for="url" id="urlLabel" class="form-label">
                  <span></span> external url related to the media
                </label>
              </div>
    ...
    <script>window.pageType = "media_add";</script>
