      ...
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="text-center border rounded bg-light mb-3 p-3">
              ...
              <h2 id="pageTitle" class="text-center txt-adc-dark"><span class="visually-hidden">page title</span></h2>
            </div>

            <div class="alert alert-light alert-dismissible fade show" role="alert">
              <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              <small>The record name is structured according to a pattern containing the prefix <strong>“DC”</strong> (short for Dynamic Collection) + the <strong>acronym of the institution</strong> that owns the artifact + the <strong>inventory number</strong> assigned when the record was created.<br>The name is assigned automatically by the system and cannot be changed.</small>
            </div>
        ...
        <form name="editArtifactForm" id="editArtifactForm">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-2">
                ...
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" role="switch" id="is_museum_copy" data-table="artifact" aria-checked="false">
          ...
          <fieldset>
            ...
            <a href="artifact_view.php?item=<?php echo $_GET['item']; ?>" class="btn btn-secondary">back to artifact</a>
          </fieldset>
        </form>
      </div>
    </main>
