          ...
          <fieldset>
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  <label for="doi">Resource DOI or URL</label>
                  <input type="text" class="form-control" placeholder="e.g. https://doi.org/10.xxxx/xxxxx or a direct repository URL" data-table="model" id="doi">
                  <small class="form-text text-muted">Provide a valid DOI (e.g. from Crossref or DataCite) or a direct link to the resource (Zenodo, Figshare, OSF, etc.).</small>
                </div>
                <!-- <div class="mb-3">
