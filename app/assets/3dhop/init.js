...
function init3dhop() {
  ...
  $("#toolbar button").on('click', function(e){
    let id = $(this).attr('id');
    if (id == 'light_on') {
      $(this).attr({"id":"light","title":"disable light control"})
      $(this).find('i').addClass('text-warning');
    }
    if (id == 'light') {
      $(this).attr({"id":"light_on","title":"enable light control"})
      $(this).find('i').removeClass('text-warning');
    }
    if (id == 'full_on') {
      $(this).attr({"id":"full","title":"exit full screen"})
      $(this).find('i').toggleClass('fa-expand fa-compress');
    }
    if (id == 'full') {
      $(this).attr({"id":"full_on","title":"full screen"})
