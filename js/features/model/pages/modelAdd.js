...
import { screenshotState } from '../../../3dhop_function.js';
  ...
  try {
    handleFormSubmit(form, {
      ...
      beforeSubmit: async (data) => {
        ...
        if (screenshotState.blob) { 
          const baseName = nxz.files[0].name.replace(/\.[^/.]+$/, "");
          data.append('thumbnail', screenshotState.blob, `${baseName}.png`); 
        }
        return data;
      },
      onSuccess: (result) => {
