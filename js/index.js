...
function populateFilterSelects(data) {
  ...
  categoryFragment.appendChild(makeDefaultOption('Category'));
  ...
  materialFragment.appendChild(makeDefaultOption('Material'));
  ...
  institutionFragment.appendChild(makeDefaultOption('Institution'));
