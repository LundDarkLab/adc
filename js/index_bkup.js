...
//     // Load first page
//     resetPagination();
//     // buildGallery(gallery, 1, false); // OLD GALLERY
//     // Qui andrai a integrare la nuova gallery
//   } catch (error) {
//     console.error('Error initializing app:', error);
//   }
// }

// function handleScroll() { // OLD GALLERY
//   const scrollTop = $window.scrollTop();
//   const windowHeight = $window.height();
//   const documentHeight = $document.height();
  
//   handleStatsVisibility(scrollTop);
//   handleInfiniteScroll(gallery, scrollTop, windowHeight, documentHeight);
// }
